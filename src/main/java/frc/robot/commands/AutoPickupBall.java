...
public class AutoPickupBall extends CommandBase {
   ...
   */
  public AutoPickupBall(PixyCamSubsystem pixy, DrivetrainSubsystem drivetrain) {
    ...
    pidDistance = new PIDController(
      0.02, //Vars.AUTO_BALL_PICKUP_DISTANCE_P, 
      0, //Vars.AUTO_BALL_PICKUP_DISTANCE_I, 
      0); //Vars.AUTO_BALL_PICKUP_DISTANCE_D);
    pidAngle = new PIDController(
      0.02, //Vars.AUTO_BALL_PICKUP_ANGLE_P,
      0,
      0);
    pidDistance.setTolerance(2); //Vars.AUTO_BALL_PICKUP_TOLERANCE);
  }
...
/**
  ...
  public void execute() {
    ...
    double A = 29.5 /*Vars.PIXY_FoV_OFFSET*/ - m_pixy.PIXY_BALL_ANGLE;
    double C;
